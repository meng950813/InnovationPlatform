...
class ExpertController extends Controller {
    ...
    public function expertlist(){
        ...
        $expertlist = $ExpertInfo->where($where)->order('sort desc,click desc')->page(I('get.p',1).',20')->getField('id,realname,work_college,logo,level,research,research_content,setup_time');
    ...
    public function expert(){
        ...
        // 点击量 加1 
        M('ExpertUser')->where($where)->setInc('click');
